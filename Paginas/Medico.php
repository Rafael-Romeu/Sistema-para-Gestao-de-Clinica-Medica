...
<script>
    ...
    function AlterarCadastro(){
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/AlteraCadastroMedico.php?" + envio, true);
        xmlhttp.send();  
    }
    ...
    function ShowPopup(consultaCodigo) {
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/ShowPopup.php?" + envio, true);
        xmlhttp.send();
    }
    function EditaConsulta(consultaCodigo) {
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/EditaConsulta.php?"+envio, true);
        xmlhttp.send();
    }
