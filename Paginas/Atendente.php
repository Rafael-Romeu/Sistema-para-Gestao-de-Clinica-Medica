...
<script>
    ...
    function CadastrarPaciente(){
        ...
        xmlhttp.open("GET",  "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/CadastraPaciente.php?" + envio, true);
        xmlhttp.send();  
    }
    ...
    function CadastrarMedico(){
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT'];?>/ServerScripts/CadastraMedico.php?" + envio, true);
        xmlhttp.send(); 
    }
    ...
    function CadastrarAtendente(){
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/CadastraAtendente.php?" + envio, true);
        xmlhttp.send();
    }
    
    function CarregaEspecialidades() {
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/CarregaEspecialidades.php?", true);
        xmlhttp.send();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
    ...
    function CarregaHorarios() {
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/CarregaHorarios.php?Medico=" + medico + "&Dia=" + dia, true);
        xmlhttp.send(); 
    }
    ...
    function VerificaCpf() {
        ...
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/VerificaCpfPaciente.php?cpf="+cpf, true);
        xmlhttp.send();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
    ...
    function AgendarConsulta() {
        ...
        xmlhttp.open("GET", "<?php $_SERVER['DOCUMENT_ROOT']?>/ServerScripts/AgendaConsulta.php?"+envio, true);
        xmlhttp.send();
    }
